    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_url', models.URLField(default=b'http://127.0.0.1:8000/metashare', help_text=b'(Read-only) base URL for the server where the master copy of the associated language resource is located.', editable=False)),
                ('identifier', models.CharField(help_text=b'(Read-only) unique identifier for this storage object instance.', max_length=64, null=True, editable=False, blank=True)),
                ('created', models.DateTimeField(help_text=b'(Read-only) creation date for this storage object instance.', auto_now_add=True)),
                ('modified', models.DateTimeField(help_text=b'(Read-only) last modification date of the metadata XML for this storage object instance.', auto_now=True)),
                ...
                ('metashare_version', models.CharField(default=b'3.1.1', help_text=b'(Read-only) META-SHARE version used with the storage object instance.', max_length=32, editable=False)),
                ('legacy_resource', models.BooleanField(default=False, help_text=b'Specifies whether the resource is collected by ELRC 1')),
