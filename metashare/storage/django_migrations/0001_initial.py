    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_url', models.URLField(default=b'http://localhost:8000', help_text=b'(Read-only) base URL for the server where the master copy of the associated language resource is located.', editable=False)),
