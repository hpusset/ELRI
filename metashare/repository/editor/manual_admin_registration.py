...
from metashare.repository.models import resourceInfoType_model, \
    ...
    relationInfoType_model, corpusMediaTypeType_model, \
    corpusTextInfoType_model, languageDescriptionInfoType_model, \
    languageDescriptionTextInfoType_model, lexicalConceptualResourceInfoType_model, \
    lexicalConceptualResourceTextInfoType_model, toolServiceInfoType_model, \
