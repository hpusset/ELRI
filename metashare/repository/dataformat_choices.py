...
MIMETYPELABEL_TO_MIMETYPEVALUE[u'TBX (Term Base eXchange)'] = u"application/x-tbx"
...
MIMETYPEVALUE_TO_MIMETYPELABEL[u'application/x-tbx'] = u"TBX (Term Base eXchange)"
